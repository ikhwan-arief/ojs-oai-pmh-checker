...
- Pada versi GitHub Pages, proxy CORS bergantung pada layanan publik pihak ketiga. Jika proxy sedang bermasalah, jalankan versi Streamlit lokal atau deploy ke Streamlit Community Cloud.
